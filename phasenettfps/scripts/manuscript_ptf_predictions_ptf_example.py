"""
manuscript_ptf_predictions_ptf_example.py:

This script is used to generate PhaseNet-TF first round PTF picks examples to show the performance.
"""
...
# ]
TEXT_INFO = [
    "3232(2009-11-25 16:42:22.31 20.19S,177.45W 511.4km) A01",
    "4103(2009-11-30 06:52:49.41 21.74S,175.56W 89.0km) EUAP",
    "4386(2009-11-12 16:15:25.07 20.33S,177.32W 437.4km) NMKA",
    "4478(2009-11-15 12:37:33.24 19.22S,177.01W 540.1km) NMKA",
]
...
def load_waveform_spectrogram_prediction(event_id, station_id):
    waveform_h5 = resource(["waveforms", "waveform_ps_v1.h5"], normal_path=True)
